...
%%
FAchange = [0.1333,0.0167,0.0833,0,0.0417,0.0333,-0.0333,0.0500];
...
[Rraw PR] = corrper(diffFA,FAchange,5000);

[coeff, S] = polyfit(diffFA, FAchange, 1);
x_fit = linspace(min(diffFA), max(diffFA), 100);
...
xlabel('Decrease of Beta','FontSize',25,'FontWeight','bold');
ylim([-0.15 0.2]);
xlim([-2.2 1.7]);
set(gca,'FontSize',20,'XTick',-2:0.5:1.5,'FontWeight','bold');
set(gca,'FontName','Times New Roman','FontWeight','bold');
